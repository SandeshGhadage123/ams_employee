...
class UserHomeScreen extends StatefulWidget {
  ...
  const UserHomeScreen({Key? key, required this.employeeLoginPostModel})
      : super(key: key);
...
class _UserHomeScreenState extends State<UserHomeScreen> {
  ...
  void getEmployeeDashboard() async {
    getDashboard = (await EmployeeNetworkHandler().employeeDashboard(
        token: widget.employeeLoginPostModel.tokens?.access?.token ?? ""))!;
                            ...
                            children: [
                              Row(
                                children: [
                                  ...
                                  Text(
                                    getDashboard?.last7Days.the20221203  ?? "",
